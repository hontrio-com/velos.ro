...
export default async function SmartPage({ params }: Props) {
  ...
  // If no smart page configured or inactive, still show a basic page using the booking form
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F7F8FA]">
        ...
        <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-[#E5E7EB]">
          <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 min-w-0">
              {statie.logo_url ? (
                <img src={statie.logo_url} alt={statie.nume}
                  className="h-9 w-9 rounded-xl object-cover border border-[#E5E7EB] shrink-0" />
              ) : (
                <div className="h-9 w-9 rounded-xl flex items-center justify-center shrink-0 text-white font-bold text-sm"
              ...
              <div className="min-w-0">
                ...
                {locationShort && (
                  <p className="text-[11px] text-[#9CA3AF] truncate">{locationShort}</p>
                )}
              </div>
            </div>
        ...
        {/* ── HERO ── */}
        <section className="relative overflow-hidden" style={{ background: `linear-gradient(135deg, ${accent} 0%, ${accent}cc 100%)` }}>
        ...
        <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
          ...
          {/* ── BOOKING SECTION ── */}
          <section id="programare" className="scroll-mt-20">
            ...
            <div className="space-y-3">
              {statie.telefon && (
                <a href={`tel:${statie.telefon}`} className="flex items-center gap-3 group">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#E5E7EB] shrink-0 group-hover:border-[#E5E7EB]" style={{ backgroundColor: `${accent}10` }}>
              ...
              {whatsappNr && (
                <a href={`https://wa.me/${whatsappNr.replace(/\D/g, "")}`} target="_blank" rel="noreferrer"
                  ...
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl shrink-0" style={{ backgroundColor: "#25D36615" }}>
              ...
              {locationShort && (
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-[#E5E7EB] shrink-0" style={{ backgroundColor: `${accent}10` }}>
